...
def render_condor_submit(template, rows, executor):
    ...
    The template is generated by the matching manual executor; only its
    documented row macros are substituted.  This deliberately does not try to
    interpret arbitrary historical submit-file dialects.
    """
